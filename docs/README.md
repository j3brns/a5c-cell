...
| [ADR-021](decisions/ADR-021-platformstack-split-plan.md) | PlatformStack split plan — storage, compute, and SPA extraction into separate CDK stacks (phased, no big-bang) |
